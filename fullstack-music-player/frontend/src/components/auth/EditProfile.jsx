        ...
        <div className="editprofile-wrapper">
            ...
            <form className="editprofile-form" onSubmit={handleSubmit}>
                {!showPasswordFields && (
                    ...
                    <Input label={"Email"} type={"text"} placeholder={"Update your email"} value={email} onChange={(e) => setEmail(e.target.value)} />
                    </>
                )}
                ...
                <div className="editprofile-actions">
                    <button type="button" className="editprofile-btn-cancel" onClick={onClose} disabled={isLoading}>Cancel</button>
